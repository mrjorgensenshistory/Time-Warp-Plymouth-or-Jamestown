# John Rolfe Route — Time Warp: Plymouth or Jamestown

> Jamestown side. The cash-crop spine of the whole game.
...
## Slide 1 — The Sea Venture

**Image brief:** A heavy English merchant ship — the Sea Venture — under full sail on a bright Atlantic. Period-engraving style. A young man in a dark coat stands at the rail with a small wooden chest at his feet. His wife sits on a coil of rope nearby, holding a swaddled infant. Low saturation, warm noon light. Wikimedia naval painting aesthetic.
**Audio:** Spanish nylon-string guitar bed fades in from 0 over 2 seconds, volume 0.5. A single wooden ship-creak SFX on load. No drum.
**Timeline bar:** Pre-revealed historical context faintly visible (1492, 1513, 1521, 1533, 1565, 1587, 1590). The current year `1609` glows softly, no event-text yet.
...
## Slide 2 — The Hurricane

**Image brief:** Storm at sea. The Sea Venture pitched on a black wave, sails ripping, lightning splitting the sky. White spray, no visible figures. Wikimedia public-domain naval-storm painting.
**Audio:** Guitar drops out for one beat. Heavy storm SFX — rain, rope-strain, distant thunder. Guitar returns at end of slide, slower, in a minor key.
**Timeline bar:** `1609` solid. Label appears: "1609 — Sea Venture wrecks in Bermuda."
...
**Timeline bar:** `1610` glows. Label: "1610 — Rolfe arrives Jamestown."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** Faded out for gameover slides.
**Slide text overlay:** None — full-bleed cutscene.
...
**Timeline bar:** `1611` glows. No new label yet.
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1612` glows. Label: "1612 — First sweet Virginia tobacco crop."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1614` glows. Label: "1614 — Tobacco shipped to England."
...
**Timeline bar:** `1614` solid. Second event added: "1614 — Marriage to Pocahontas."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1616` glows. Label: "1616 — Travel to England."
**Slide text overlay:** Parchment ship's-log card.

**Body text:**
> The Virginia Company wants Pocahontas in London. They want to show the investors that the colony is civilized — that a Powhatan princess can be a Christian woman in an English dress.
> She agrees. She wants to see the country her husband came from. She wants Thomas to know it.
...
**Timeline bar:** `1617` glows. Label: "1617 — Pocahontas dies in Gravesend."
**Slide text overlay:** Parchment ship's-log card.
...
**Body text (small caption, Share Tech):**
> I stay in England. I take a clerk's job in London. The Virginia Company strips my plantation and gives it to another planter.
> Thomas grows up English. He never crosses the Atlantic. He never asks me about his mother's people, because I cannot answer.
...
**Body text:**
> I leave Thomas with his uncle in Plymouth, England. He will be raised by his grandfather's people. I tell him I will come back for him. I do not know if I am lying.
...
**Timeline bar:** `1618` glows softly. No event label — this is a transition year.
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1619` glows. Label: "1619 — First enslaved Africans arrive at Virginia."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1619` solid. Two events on the bar for that year now.
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1619` adds a third event-tick: "1619 — House of Burgesses meets (first elected assembly in English America)."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1620` (Mayflower lands at Plymouth — pre-revealed) softly highlights as the year passes. `1621` (first Thanksgiving) softly highlights. These are not Rolfe's events — they appear dimmer, as context.
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** `1622` glows. Label: "1622 — Powhatan Uprising."
**Slide text overlay:** Parchment ship's-log card.
...
**Timeline bar:** All ten Rolfe events solid. Pre-revealed context events still visible at lower opacity. The bar is full.
